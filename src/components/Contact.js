    ...
    <Container fluid className="contact-container">
      ...
      {showAlreadySubmittedMessage && (
        <Alert variant="warning" className="fixed-message">
          <FaExclamationTriangle className="me-2" /> Your number has already been stored. We will contact you soon.
        </Alert>
      )}
      ...
      <Row className="contact-row">
        <Col md={5} className="contact-info">
          ...
          <ul>
            ...
            <li>
              <i className="fas fa-map-marker-alt"></i> 132 Villianur Street, Pondicherry
              <br />
              605110, India
            </li>
          </ul>
