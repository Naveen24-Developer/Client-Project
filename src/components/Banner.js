...
const Banner = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://8e71-59-97-51-97.ngrok-free.app/shop/post-categories/", {
        method: "POST",
        headers: {
    ...
    <div className="banner-section">
      ...
      {showAlreadySubmittedMessage && (
        <Alert variant="warning" className="fixed-message">
          <FaExclamationTriangle className="me-2" /> Your number is already stored. We will contact you soon!
        </Alert>
      )}
        ...
        <Container>
          <Row className="align-items-center">
            <Col md={6} className="banner-content">
              ...
              <h5>
                From Borewell Drilling to Groundwater Solutions, our precision-led,
                expertise-driven approach ensures sustainable water access for your needs.
              </h5>
